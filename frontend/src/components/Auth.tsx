...
import type { SignupInput } from "@thapamohit/medium-common";
...
try {
  ...
  return (
    <div className="h-screen flex  justify-center flex-col">
        ...
        <div className="pt-4">
      {type === "signup" ?   <LabelledInput label='Name' placeholder="Mohit Thapa..." onChange={(e) => {
            setPostInputs({
                ...postInputs,
                name:e.target.value
            })
...
function LabelledInput({label, placeholder, onChange, type}:LabelledInputType ) {
    return <div>
    <label className="block mt-3  text-sm font-bold text-black">{label}</label>
